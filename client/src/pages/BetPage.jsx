...
const BetPage = () => {
  ...
  ? 'https://rocky-hollows-26852-54ebc26e9935.herokuapp.com/api/simplified-bovada-data'
  ...
  const renderMatchupButtons = (matchup) => (
    <tr key={matchup.matchup} className="border-royalBlueTop" >
      ...
      <td className="text-xs md:text-sm lg:text-lg font-bold royalBlue text">{matchup.matchup}</td>
