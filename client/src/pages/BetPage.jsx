...
const BetPage = () => {
  ...
  const renderMatchupButtons = (matchup) => (
    <tr key={matchup.matchup} className="border-royalBlueTop" >
      <div className="tooltip" data-tip="Click To See Matchup Details">
      <td className="text-xs md:text-sm font-bold royalBlue underline text"  onClick={()=>document.getElementById('my_modal_4').showModal()}>{matchup.matchup}</td>
